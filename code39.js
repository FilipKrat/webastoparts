 ...
 */
		...
		function DrawCode39Barcode(data,
						   checkDigit)
		{
			return DrawHTMLBarcode_Code39(data,checkDigit,"yes","cm", 0,3,0.4,3,"bottom","center", "","black","white"); 
		}
		
		function DrawCode39Barcode(data,
						   checkDigit, width, height)
		{
			return DrawHTMLBarcode_Code39(data,checkDigit,"yes","cm", 0,width,height,3,"bottom","center", "","black","white"); 
		}
						    ...
						    mode)
		{
			  ...
			  if (mode=="html")
			  {
				  ...
				  {
					if (textStyle=='')
						humanSpan='<br /><span style="font-family : arial; font-size:8px">'+humanReadableText+'</span>';
					else
